...
<head>
    ...
    <title>{{ $metaTitle /*ya se esta agregando desde la clase por eso quitamos el ?? 'Default title'*/  }}</title>
...
<body>
        ...
        <div class="container-fluid">
            ...
            <main>
            {{-- 
            tenemos mensajes de seesion flash que apareceran debajo de la navegacion
            en cualquier vista que tenga el layout  --}}
            @session('status')
            <x-alert type="info">
              <x-slot name="titulo_alerta">{{ $value }}</x-slot>
            </x-alert>
            ...
            <div id="siderbar">
                <h3>Sidebar</h3>
                <div>{{ $sidebar }}</div> <!--  $sidebar se le conoce como propiedad del componente -->
            </div>        
            @endisset
            --}}
            {{-- @endif --}}
         ...
         <footer class="d-flex flex-wrap justify-content-between align-items-center py-3 my-4 border-top">
                  <div class="col-md-4 d-flex align-items-center">
                    ...
                    <span class="mb-3 mb-md-0 text-body-secondary">© 2025 Jorge Mostiga, All Rigths Reservered</span>
                  </div>
                  ...
                  <ul class="nav col-md-4 justify-content-end list-unstyled d-flex">
                    ...
                    <li class="ms-3"><a class="text-body-secondary" href="#"><svg xmlns="http://www.w3.org/2000/svg" width="25" height="25" fill="currentColor" class="bi bi-twitter" viewBox="0 0 16 16">
                    ...
                    <li class="ms-3"><a class="text-body-secondary" href="#"><svg xmlns="http://www.w3.org/2000/svg" width="25" height="25" fill="currentColor" class="bi bi-instagram" viewBox="0 0 16 16">
                      ...
                      <li class="ms-3"><a class="text-body-secondary" href="#"><svg xmlns="http://www.w3.org/2000/svg" width="25" height="25" fill="currentColor" class="bi bi-tiktok" viewBox="0 0 16 16">
